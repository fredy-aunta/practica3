				...
				<div class="container no_left no_right">
					<div class="row">
						...
						<div class="col-md-4 col-xs-12">
							...
							<div class="logo">
								<a href="index.php">
									<h1>TECHNO<span class="blue">LOGIX</span> </h1>
								</a>
				...
				<div class="first-part">
					...
					<div class="slide">
						<div id="wowslider-container1">
							<div class="ws_images"><ul>
									<li><img src="images/header1.jpg" alt="" title="TECHNOLOGIX WEBSITE" id="wows1_0"/>YOUR OWN IMAGES AND SLOGANS</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<nav>
						<ul>
							<li>
								<i></i>
								<a class="gradient-blue" href="index.php">HOME</a>
							</li>
							<li class="active">
								<i></i>
								<a class="gradient-lightblue" href="architecture.php">ARCHITECTURE</a>
							</li>
							<li>
								<i></i>
								<a class="gradient-green" href="materials.htm">MATERIALS</a>
							</li>
							<li>
								<i></i>
								<a class="gradient-oranje" href="equipments.htm">EQUIPMENTS</a>
							</li>
							<li>
								<i></i>
								<a class="gradient-red" href="services.htm">SERVICES</a>
							</li>
							<li>
								<i></i>
								<a class="gradient-pink" href="products.htm">PRODUCTS</a>
							</li>
							<li>
								<i></i>
								<a class="gradient-purple" href="careers.htm">CAREERS</a>
							</li>
						</ul>
					</nav>
					...
					<div class="row">
						<div class="col-md-8 col-xs-12">
							...
							<div class="content-text">
								...
								<a class="fr" href="index.php">Go back >></a>
						...
						<aside class="col-md-4 col-xs-12">
							<div class="news"> 
								<h2 class="blue">LASTED NEWS</h2>
								<ul class="bloc">
									<li>
										<p><span class="date">11/12/2008</span> Lorem Ipsum dolor </p>
										<a href="news.htm">Pellentesque sit amet eros ac tellus pharetra tempor. Duis urna felis,...</a>
									</li>
									<li>
										<p><span class="date">11/12/2008</span> Lorem Ipsum dolor </p>
										<a href="news.htm">Pellentesque sit amet eros ac tellus pharetra tempor. Duis urna felis,...</a>
									...
									<li class="no_style">
										<a href="list-new.htm" class="fr see-all">All news &gt;&gt;</a>
									</li>
								</ul>
